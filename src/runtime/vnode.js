...
/*1、element
  ...
  2、text
    文本节点，document.createTextNode创建
    type:Symbol，props空，children字符串
  3、Fragment
    不会真是渲染的节点，相当于template
    type:Symbol,props空，children数组
  4、Component
    组件，有自己渲染方法，是上三种集合
    type:组件对象，props：组件props,children：slot

    第四个属性：ShapeFlags标记
    辨识VNode类型和children类型
